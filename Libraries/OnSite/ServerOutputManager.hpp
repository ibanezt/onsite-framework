#ifndef GUARD_SERVEROUTPUTMANAGER_H
#define GUARD_SERVEROUTPUTMANAGER_H
/** 	
...
namespace OnSite {
	class ServerOutputManager {
		public:
			//Constructor
			ServerOutputManager(std::shared_ptr<OnSite::ConcurrentQueue<OnSite::MessagePacket>> pcqOut);
			//Deconstructor
			~ServerOutputManager();
