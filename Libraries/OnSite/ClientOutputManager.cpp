/**
 *	ClientOutputManager Class Definition
 *	Terrell Ibanez
**/
...
//Constructor
OnSite::ClientOutputManager::ClientOutputManager(std::shared_ptr<OnSite::ConcurrentQueue<OnSite::MessagePacket>> pcqOut) {
...
//Deconstructor
OnSite::ClientOutputManager::~ClientOutputManager() {
	//Clear HashMap
...
void OnSite::ClientOutputManager::addClient(int fdSocket) {
...
void OnSite::ClientOutputManager::removeClient(int fdSocket) {
	//Acquire Lock for Thread Safety
	std::lock_guard<std::mutex> lock(mLock);
...
std::tuple<char*, size_t> OnSite::ClientOutputManager::getBytes(int fdSocket) {
	//Acquire Lock for Thread Safety
	std::lock_guard<std::mutex> lock(mLock);
...
void OnSite::ClientOutputManager::rewind(int fdSocket, size_t nBytes) {
	//Acquire Lock for Thread Safety
	std::lock_guard<std::mutex> lock(mLock);
...
void OnSite::ClientOutputManager::processQueue() {
	//Acquire Lock for Thread Safety
	std::lock_guard<std::mutex> lock(mLock);
...
std::tuple<int*, size_t> OnSite::ClientOutputManager::getSockets() {
	//Acquire Lock for Thread Safety
	std::lock_guard<std::mutex> lock(mLock);
...
void OnSite::ClientOutputManager::setMonitoring(int fdSocket, bool flag) {
	//Acquire Lock for Thread Safety
	std::lock_guard<std::mutex> lock(mLock);
...
bool OnSite::ClientOutputManager::getMonitoring(int fdSocket) {
	//Acquire Lock for Thread Safety
	std::lock_guard<std::mutex> lock(mLock);
